...
<div class="confirm_approve d-flex bg-light" style="height: 100vh;">
    ...
    <div class="w-100 p-3">
        ...
        <form action="<?php echo URLROOT?>/request/approve" method="post" class="bg-white rounded p-3 border col-4">
            <h5>Are you sure you want to approve this file request?</h5>
