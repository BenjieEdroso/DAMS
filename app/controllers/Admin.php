...
<td><a href='".URLROOT."/admin/edit_user?user_id=$response->user_id'
class='btn btn-sm btn-primary'>Edit</a><button id='deleteBtn' class='btn btn-sm btn-danger ms-2' data-bs-toggle='modal'
    data-bs-target='#confirmDeleteModal'>Delete</button>
<a href='".URLROOT."/admin/change_pass?id=$response->user_id' class='btn btn-sm btn-secondary'>Change
Password</a>
    ...
    <div class='modal-dialog' role='document'>
        <div class='modal-content'>
            ...
            <div class='modal-body'>
                <a href='".URLROOT."/admin/delete_user?user_id=$response->user_id' class='btn btn-sm btn-primary'>Yes</a>
